...
export interface IRRSFiniteStateMachineContextConsumerProps<ComponentProps = {}, RunProps = {}, ERSFiniteStateMachineState extends string | number | symbol = string, ReduxStoreState = undefined> {
...
//# sourceMappingURL=IRRSFiniteStateMachineContextConsumerProps.d.ts.map