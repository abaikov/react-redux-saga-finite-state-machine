...
export interface IRRSFiniteStateMachineHookProps<RunProps = {}, ERSFiniteStateMachineState extends string | number | symbol = string, ReduxStoreState = undefined> {
...
//# sourceMappingURL=IRRSFiniteStateMachineHookProps.d.ts.map